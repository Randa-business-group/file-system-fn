...
export function LandingFooter() {
  ...
  return (
    <footer className="border-t border-default bg-[var(--color-bg-tertiary)]">
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-12 lg:gap-8">
          <div className="sm:col-span-2 lg:col-span-5">
            <LandingBrandLogo />
            <p className="mt-4 max-w-sm text-sm leading-relaxed text-secondary">
              Secure document management for teams that need organization,
              collaboration, and peace of mind — all in one vault.
            </p>
        ...
        <div className="mt-12 flex flex-col gap-4 border-t border-default pt-8 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-sm text-muted">
            © {year} FileVault. All rights reserved.
          </p>
