        ...
        <div className="ml-auto hidden items-center gap-3 md:flex">
          {!isLoading && isAuthenticated && user ? (
            ...
            <>
              <Link
                href="/login"
                className="rounded-lg px-4 py-2 text-sm font-medium text-secondary no-underline transition hover:bg-[var(--color-bg-secondary)] hover:text-foreground hover:no-underline"
              >
                Sign in
              </Link>
              <Link
                href="/register"
                className="rounded-lg bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground no-underline shadow-sm transition hover:bg-primary-hover hover:no-underline"
              >
                Sign up
              </Link>
            </>
