				...
				<div className='mt-14 grid gap-6 lg:grid-cols-3'>
					{PRICING_PLANS.map((plan) => (
						<article
							key={plan.id}
							className={[
								"relative flex flex-col rounded-lg border p-6 shadow-sm sm:p-8",
								plan.highlighted
						...
						>
							...
							<Link
								...
								className={[
									"mt-8 inline-flex items-center justify-center rounded-md px-4 py-3 text-sm font-semibold no-underline transition hover:no-underline",
									plan.highlighted
