			...
			<div className='relative mx-auto max-w-7xl px-4 pb-8 pt-8 sm:px-6 sm:pb-12 sm:pt-10 lg:px-8 lg:pb-16 lg:pt-12'>
				...
				<div className='mx-auto max-w-3xl text-center'>
					...
					<h1 className='text-4xl font-semibold leading-[1.08] tracking-tight text-foreground sm:text-5xl lg:text-[3.25rem]'>
						Document. <span className='text-primary'>Organized, secure, and found in seconds.</span>
					</h1>
					...
					<div className='mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row'>
						<Link
							href='/register'
							className='inline-flex items-center justify-center gap-2 rounded-md bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground no-underline shadow-md transition hover:text-primary-foreground hover:bg-primary-hover hover:no-underline'
						>
							Start free trial
						...
						<a
							href='/#how-it-works'
							className='inline-flex items-center justify-center rounded-md border border-default bg-surface px-6 py-3 text-sm font-semibold text-foreground no-underline transition hover:bg-[var(--color-bg-secondary)] hover:no-underline'
						>
							See how it works
						</a>
					</div>
